...
CREATE TABLE `USERS` (
	...
	`URES` VARCHAR(255) NULL     COMMENT '회원자기소개서' -- 회원자기소개서
)
COMMENT '회원';
...
CREATE TABLE `UEXPS` (
	...
	`EXPWC` VARCHAR(255) NOT NULL COMMENT '경력업무내용', -- 경력업무내용
...
CREATE TABLE `CINFOS` (
	...
	`CINT`  VARCHAR(255) NULL     COMMENT '기업설명', -- 기업설명
...
CREATE TABLE `CRECS` (
	...
	`REWC`  VARCHAR(255) NOT NULL COMMENT '주요업무', -- 주요업무
...
CREATE TABLE `ULANS` (
	...
	`LGLVL` VARCHAR(255) NOT NULL COMMENT '외국어수준', -- 외국어수준
	`UNO`   INTEGER      NOT NULL COMMENT '회원일련번호' -- 회원일련번호
)
COMMENT '외국어';
...
CREATE TABLE `CPJTS` (
	...
	`CPJINT` VARCHAR(255) NOT NULL COMMENT '설명', -- 설명
...
CREATE TABLE `UPJTNO` (
	...
	`PJDT` VARCHAR(255) NOT NULL COMMENT '프로젝트상세설명', -- 프로젝트상세설명
...
CREATE TABLE `PJTBDS` (
	...
	`PBCT`  VARCHAR(255) NOT NULL COMMENT '게시물내용', -- 게시물내용
...
CREATE TABLE `REBDS` (
	...
	`RBCT` VARCHAR(255) NOT NULL COMMENT '게시물내용', -- 게시물내용
